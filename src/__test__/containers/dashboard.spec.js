...
describe('Describes dashboard', () => {
  ...
  it('renders user dashboard correctly', () => {
    ...
    expect(component.find('DashboardProfile').exists()).toBe(true);
    expect(component.find('DashboardHeader').exists()).toBe(true);
    expect(component.find('DashboardHeaderIntervention').exists()).toBe(true);
    expect(component.find('NavLinkHeader').exists()).toBe(true);
  });
});
